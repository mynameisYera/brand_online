...
//         ..src = _buildEmbedUrl(enableJsApi: _useJsApi, showControls: false)
//         ..style.border = 'none'
...
//     if (_iframe == null || !_useJsApi) return;
...
//         final readyMessage = json.encode({
//           "event": "command",
//           "func": "addEventListener",
//           "args": ["onReady"]
//         });
//         _iframe!.contentWindow?.postMessage(readyMessage, '*');
...
//           "args": ["onError"]
//         });
//         _iframe!.contentWindow?.postMessage(errorMessage, '*');
...
//     _jsApiInitTimer?.cancel();
//     _jsApiInitTimer = Timer(const Duration(seconds: 4), () {
//       if (mounted && _useJsApi && !_jsApiReady) {
//         L.info('Video', 'JS API не отвечает, переключаемся на стандартный плеер.');
//         _switchToFallbackEmbed();
//       }
//     });
//   }
...
//       final errorCode = message['data'] as int?;
...
//                     ),
//                   ),
//                 if (_showControls && _isExpanded) _buildExpandedControls(),
//               ],
//             ],
//           ),
//         ),
...
//           // Элементы управления
//           if (_showControls && _useJsApi && _jsApiReady)
...
//       if (_iframe != null && mounted && _isPlaying && !_isSliderDragging && _useJsApi) {
//         final message = json.encode({
//           "event": "command",
//           "func": "getVideoData",
//           "args": []
...
//   String _buildEmbedUrl({required bool enableJsApi, required bool showControls}) {
//     final base = Uri.base;
//     final hasHost = base.scheme.isNotEmpty && base.host.isNotEmpty;
//     final origin = hasHost
...
//       if (origin != null && enableJsApi) 'origin': origin,
//       if (origin != null && enableJsApi) 'widget_referrer': origin,
//       'start': '0',
//     };
//     return Uri.https('www.youtube.com', '/embed/$_videoId', params).toString();
//   }

//   void _switchToFallbackEmbed() {
//     if (!_useJsApi) return;
//     setState(() {
//       _useJsApi = false;
//       _jsApiReady = false;
...
//     if (_iframe != null) {
//       _iframe!
//         ..src = _buildEmbedUrl(enableJsApi: false, showControls: true)
